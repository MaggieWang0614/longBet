...
count_iter <- 0
if (!exists("longBet_sim.RData")){
  save(count_iter, tau_mat, file = "longBet_sim.RData")
}
...
for (iter in 1:mc){
  ...
  count_iter <- iter
  save(count_iter, tau_mat, tau_xbcf_mc, tau_freq_mc, file = "longBet_sim.RData")
